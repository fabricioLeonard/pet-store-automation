...
import api.endpoints.UserEndPointsToProperties;
...
public class UserTestsToProperties {
    ...
    public void testCreateUser() {
        ...
        Response response = UserEndPointsToProperties.createUser(userPayload);
    ...
    public void testReadUserByName(){
        ...
        Response response = UserEndPointsToProperties.readUser(userName);
        response.then().log().all();
    ...
    public void testUpdateUser() {
        ...
        Response response = UserEndPointsToProperties.updateUser(userPayload, userName);
        response.then().log().body();
        logger.info("-> User  updated");
        Assert.assertEquals(response.getStatusCode(), 200);

        //Checking data after update
        Response responseAfterUpdate = UserEndPointsToProperties.readUser(userName);
    ...
    public void testDeleteUserByName(){
        ...
        String userName = userPayload.getUsername();
        Response response = UserEndPointsToProperties.deleteUser(userName);
        response.then().log().all();
        Assert.assertEquals(response.getStatusCode(), 200);
